...
public class ObjectProject4_Contains {
	...
	public static void highest(Cuenta[] c, int count) {
		...
		System.out.println("La cuenta con mayor saldo es "+c[pos].getTitle()+" con "+c[pos].getCant()+"€ de saldo.");
	}
